...
export default function Home() {
    ...
    return (
      <Carousel activeIndex={index} onSelect={handleSelect} style={{height: "300px", width:"60%"}} interval="2000">
        <Carousel.Item style={{height : "300px", backgroundImage : "url(" + img1 + ")", backgroundSize : "cover", backgroundColor : "rgba(9, 5, 5, 0.64)"}} >
