        ...
        <div class="new-class">
            ...
            <div class="class-con sign-up">
                <div class="class-con-item">
                    ...
                    We will start from the basics and build up, preparing for the USACO contests and learning about computing optimization and algorithms. The course will be taught in java but if you know any language well you will be fine.</p>
                    {/* <Carousel /> */}
                ...
                <div class="class-con-item" style={{gridTemplateRows: "repeat(2, auto)"}}>
                    ...
                    <div class="sign-up-steps" style={{marginBottom: "0"}}>
                        ...
                        <div class="step">
                            <i class="fas fa-arrow-alt-circle-right"></i>
                            <p>Detailed Explanations for Practice Problems</p>
                        </div>
                        <div class="step">
                            <i class="fas fa-arrow-alt-circle-right"></i>
                            <p>Online Tutoring</p>
