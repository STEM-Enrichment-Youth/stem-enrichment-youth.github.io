                ...
                <div class="head-txt" style={{ width: "90%", marginLeft: "5%" }}>
                    <div >
                        <div>
                            ...
                            <h1 style={{ textAlign: "center" }} class="biggest-header-4">STEM Tober</h1>
                            <h2 style={{ textAlign: "center", fontSize: "23px", marginBottom: "30px" }}> Free STEM Speaker Series in partnership with Wave Learning Festival</h2>
                            <p style={{textAlign: "center"}}><a class="btn btn-full" >Sign Up Below to Receive Updates!</a></p>
                            <p style={{textAlign: "center"}}><a class="btn btn-full" href="https://www.wavelf.org/">Check out our partner: Wave Learning Festival!</a></p>
                                ...
                                <Row>
                                    <Col sm={6}>
                                        <div style={{ textAlign: "left", lineHeight: "2", width: "90%", marginLeft: "5%" }}>
                                            <h2 style={{ textAlign: "left", lineHeight: "2"}}> Saturday 10/3 </h2>
                                            <p>Researchers and Students from ENGINEERING Disciplines</p>
                                            <p style={{textAlign: "left"}}><a class="btn btn-full" href="https://www.instagram.com/stemenrichmentyouth/">View our Speakers!</a></p>
                                        </div>
                                    </Col>
                                    <Col sm={6}>
                                        <div style={{ textAlign: "left", lineHeight: "2", width: "90%", marginLeft: "5%" }}>
                                            <h2 style={{ textAlign: "left", lineHeight: "2"}}> Saturday 10/10 </h2>
                                            <p>Researchers and Students from COMPUTER SCIENCE and MATH Disciplines</p>
                                            <p>Speaker Reveal coming soon!</p>

                                        </div>
                                    </Col>
                                    <Col sm={6}>
                                        <div style={{ textAlign: "left", lineHeight: "2", width: "90%", marginLeft: "5%" }}>
                                            <h2 style={{ textAlign: "left", lineHeight: "2"}}> Saturday 10/17 </h2>
                                            <p>Researchers and Students from MEDICAL and HEALTHCARE Disciplines</p>
                                            <p>Speaker Reveal coming soon!</p>
                                        </div>
                                    </Col>
                                    <Col sm={6}>
                                        <div style={{ textAlign: "left", lineHeight: "2", width: "90%", marginLeft: "5%" }}>
                                            ...
                                            <p>Researchers and Students from NATURAL SCIENCE Disciplines</p>
                                            <p>Speaker Reveal coming soon!</p>
                                        </div>
                                    </Col>
                                </Row>
                            ...
                            <h1 class="biggest-header-2" style={{marginTop: "50px"}}>SIGN UP</h1>
                            <div style={{display: "grid", gridTemplateColumns: "1fr", justifyItems: "center"}}>
                            <iframe src="https://docs.google.com/forms/d/e/1FAIpQLSctUf_QwnzYLFq4uNaMKs7287UMlICCvhH5kMDhn1BmUGGv1w/viewform?embedded=true" width="640" height="1122" frameborder="0" marginheight="0" marginwidth="0">Loading…</iframe>
                            </div>
