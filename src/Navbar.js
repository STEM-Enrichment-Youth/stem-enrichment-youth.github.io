    ...
    <nav className={`navbar navbar-expand-lg navbar-dark bg-dark ${scrolled && 'sticky'} ${!scrolled && 'non-sticky'}`}
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <li class="nav-item dropdown nav-link active">
            ...
            class="nav-link dropdown-toggle MuiButtonBase-root MuiButton-root MuiButton-contained" href="/stemworld" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            STEM World</a>
